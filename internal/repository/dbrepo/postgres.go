...
// Insert RoomRestriction to database
...
// get UserByID return user by id
...
func (m *postgresDBRepo) GetRestrictionsForRoomByDate(roomID int, start, end time.Time) ([]models.RoomRestriction, error) {
	...
	query := `select id, reservation_id, restriction_id, room_id, start_date, end_date
...
func (m *postgresDBRepo) InsertBlockForRooms(id int, startDate time.Time) error {
	ctx, cancel := context.WithTimeout(context.Background(), 3*time.Second)
	defer cancel()
